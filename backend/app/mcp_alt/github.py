...
@server.tool()
async def MY_GITHUB_list_prs(owner: str, repo: str, state: str = "open", user_id: Optional[str] = None) -> Dict[str, Any]:
...
@server.tool()
async def MY_GITHUB_get_pr_details(owner: str, repo: str, pr_number: int, user_id: Optional[str] = None) -> Dict[str, Any]:
...
@server.tool()
async def MY_GITHUB_list_commits(owner: str, repo: str, branch: str = "main", user_id: Optional[str] = None) -> Dict[str, Any]:
...
@server.tool()
async def MY_GITHUB_create_issue(owner: str, repo: str, title: str, body: str = "", user_id: Optional[str] = None) -> Dict[str, Any]:
...
@server.tool()
async def MY_GITHUB_summarize_pr(owner: str, repo: str, pr_number: int, user_id: Optional[str] = None) -> Dict[str, Any]:
...
@server.tool()
async def MY_GITHUB_get_repo_details(owner: str, repo: str, user_id: Optional[str] = None) -> Dict[str, Any]:
...
@server.tool()
async def MY_GITHUB_list_repo_contents(owner: str, repo: str, path: str = "", user_id: Optional[str] = None) -> Dict[str, Any]:
...
@server.tool()
async def MY_GITHUB_add_pr_comment(owner: str, repo: str, pr_number: int, comment: str, user_id: Optional[str] = None) -> Dict[str, Any]:
...
@server.tool()
async def MY_GITHUB_create_pr(owner: str, repo: str, head: str, base: str, title: str, body: str = "", user_id: Optional[str] = None) -> Dict[str, Any]:
...
@server.tool()
async def MY_GITHUB_merge_pr(owner: str, repo: str, pr_number: int, merge_method: str = "merge", user_id: Optional[str] = None) -> Dict[str, Any]:
