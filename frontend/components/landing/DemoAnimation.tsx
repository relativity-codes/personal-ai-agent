        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <div className="space-y-3 font-mono text-sm" aria-live="polite">
            {DEMO_STEPS.slice(0, visibleCount).map((step, i) => (
              ...
              >
                ...
                <div
                  className={[
                    "max-w-xs rounded-xl px-3 py-2 text-xs leading-relaxed whitespace-pre-line",
                    step.role === "user"
          ...
          {visibleCount >= DEMO_STEPS.length && (
            <button
              ...
              className="mt-4 text-xs text-zinc-400 underline-offset-2 hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-400"
            >
              Replay demo
            </button>
          )}
